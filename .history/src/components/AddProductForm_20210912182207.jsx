    ...
    return (
        <div className="mt-3 row g-3 align-items-center col-12">
            <div className="col-auto">
                <input type="text" name="name" onChange={(e) => handleChange(e)} placeholder="Model name" className="form-control" value={productItem.name}/>
            </div>
            <div className="col-auto">
                <input type="text" name="brand" onChange={(e) => handleChange(e)} placeholder="Brand" className="form-control"  value={productItem.brand}/>
            </div>
            <div className="col-auto">
                <input type="text" name="price" onChange={(e) => handleChange(e)} placeholder="Price" className="form-control"  value={productItem.price}/>
            </div>
            <div className="col-auto">
                <input type="text" name="imgUrl" onChange={(e) => handleChange(e)} placeholder="Image link" className="form-control" value={productItem.imgUrl} />
            </div>
            <div className="col-auto">
