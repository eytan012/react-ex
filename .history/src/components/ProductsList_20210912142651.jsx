                                ...
                                <div className="col">
                                    <div className="card h-10">
                                        ...
                                        <div className="card-body">
                                            ...
                                            <div className="editAddButtons d-flex justify-content-space">
                                            <span className="p-2 bd-highlight"><i class="far fa-edit"></i></span>
                                            <span className="me-auto p-2 bd-highlight" ><i class="fas fa-trash-alt"></i></span>
