                                ...
                                <div className="card h-10">
                                    ...
                                    <div className="card-body">
                                        ...
                                        <div className="editAddButtons d-flex justify-content-between">
                                            <span onClick={handleDelete} style={{cursor:'pointer'}}><i className="fas fa-trash-alt text-danger"></i></span>
                                            <span onClick={handleDelete} style={{cursor:'pointer'}}><i className="far fa-edit text-primary"></i></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
