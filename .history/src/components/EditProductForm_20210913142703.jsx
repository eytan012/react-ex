...
try {
  const req = await axios.put(`http://localhost:3007/products/edit/${id}`, productToEdit)
  ...
  return (
    <div>
      ...
      />
      <button className="btn btn-info" onClick={handleSaveChanges}>Save changes</button>
